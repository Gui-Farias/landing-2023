<script>
	...
	import pt from '$lib/language/icon-pt.png';
	import en from '$lib/language/icon-en.png';
</script>
...
<nav class="nav-main header__menu">
	...
	<ul class="nav-main__lang" aria-label="Website languages">
		<li>
			<button on:click={() => ($locale = 'pt')} aria-label="Site em portugues" lang="pt">
				<img src={pt} alt="" />
			</button>
		</li>
		<li>
			<button on:click={() => ($locale = 'en')} aria-label="Site in English" lang="en">
				<img src={en} alt="" />
			</button>
		</li>
	</ul>
